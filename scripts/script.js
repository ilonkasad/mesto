...
const popupImage = viewModal.querySelector(".popup__image");
const popupSubtitle = viewModal.querySelector(".popup__subtitle");
...
function createCard(titleValue, linkValue) {
  const cardTempl = cardTemplate.content;
  const cardElement = cardTempl.cloneNode(true);
